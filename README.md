...
# 📊 Stats
<p align="left"> 
<img width="260" src="http://github-profile-summary-cards.vercel.app/api/cards/stats?username=rishabhHQ&theme=date_night"/>
<img width="520" src="http://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=rishabhHQ&theme=date_night">
</p>
...
## 🌐 Portfolio: 
Check out my work →  
**[Portfolio-1 (Static)](http://rishabh-2d-portfolio.netlify.app/)** |
**[Portfolio-2 (AI)](http://rishabh-2d-ai-portfolio.netlify.app/)** |
**[Portfolio-3 (3D Galaxy)](http://rishabh-3d-portfolio.vercel.app/)**

`All depects same thing it is up-to you which one to explore`

**[My work links](https://rishabhhq.github.io/meOrganized/)**
`These are links which I remember, not related to portfolio it is only for my ease`
 
## 🏢 Organization 
Part of **[VervainLabs](https://github.com/VervainLabs)** — building together.  
`You can also be a part of it just follow and join the community` → [Discord](https://discord.gg/B3cPuWsu3u)

---

## 📌 Additional Information:
**Issues:**
- Check 2 issues which are currently open at my [organization](https://github.com/VervainLabs).

**Current working idea:**
- [UPS](https://pollin-deb03.web.app/)
  
**I'm hiring:** 
- [Click here](https://apply-to-rishabh-lol.netlify.app/) to work with my current working idea or something else unique `(Unpaid)`
  - Currently hiring for positions for my idea: Backend Developer, Database Manager, UI/UX Designer
 
## 📜 Former Username:
📝 Changed on **28/01/2026**  
Previously known as: `rishabh-24bcs10110`
